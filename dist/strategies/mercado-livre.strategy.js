...
exports.MercadoLivreStrategy = void 0;
const axios_1 = __importDefault(require("axios"));
const cheerio_1 = require("cheerio");
const logger_1 = require("../logger");
class MercadoLivreStrategy {
    ...
    async fetchPrices({ itemName }) {
        try {
            ...
            logger_1.logger.error('Erro no MercadoLivreStrategy', {
                error: error.message,
            });
            return [];
        }
...
exports.MercadoLivreStrategy = MercadoLivreStrategy;
//# sourceMappingURL=mercado-livre.strategy.js.map